...
int CompareItems(Item *A, Item *B, int TypeOfFuntion){          //=== IMPLEMENTATION OF COMPARE ITEM ===
...
int main(void){
    ...
    do{
        ...
        switch(menu){
            ...
            case 8:
                ShowItem(EliminateItem(&ListX, CreateItem(), 0));
            break;
            ...
            case 12:
                ShowItem(PeekItem(&ListX, CreateItem(), 0));
            break;
