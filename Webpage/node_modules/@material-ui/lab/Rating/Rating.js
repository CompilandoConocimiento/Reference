...
var Rating = _react.default.forwardRef(function Rating(props, ref) {
  ...
  var _useIsFocusVisible = (0, _utils.useIsFocusVisible)(),
  ...
  var handleFocusRef = (0, _utils.useForkRef)(focusVisibleRef, rootRef);
  var handleRef = (0, _utils.useForkRef)(handleFocusRef, ref);
  ...
  var handleMouseMove = function handleMouseMove(event) {
    ...
    if (theme.direction === 'rtl') {
      percent = (right - event.pageX - (0, _utils.ownerWindow)(rootNode).pageXOffset) / (width * max);
    } else {
      percent = (event.pageX - left - (0, _utils.ownerWindow)(rootNode).pageXOffset) / (width * max);
    }
  ...
  return _react.default.createElement("div", (0, _extends2.default)({
    ...
    className: (0, _clsx.default)(classes.root, className, size !== 'medium' && classes["size".concat((0, _utils.capitalize)(size))], disabled && classes.disabled, focusVisible && classes.focusVisible, readOnly && classes.readOnly),
