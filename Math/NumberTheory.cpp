...
ull GCD(lli numberA, lli numberB){                                          //FN: Return Great Common Divider of 2 numbers
    ...
    if (numberA < 0) return numberA * -1;                                   //Remember that GCD > 0
...
int main(){
    ...
    CasualNumber = GCD(0,0);                                          //Now check the GCD of 2 negatives : Problems
    cout << "GCD is " << CasualNumber << endl;                          //Show it!

    CasualNumber = LCM(8,-10);                                          //Now check the GCD of 2 negatives : Problems
    cout << "LCM is " << CasualNumber << endl;                          //Show it!
