...
\part{Un tour de \Cpp y lo que deberías saber de el}
    ...
    \chapter{Bases del Lenguaje}
        ...
        \section{Ciclos}
            ...
            % =======           FOR                =======
            % ============================================
            \subsection{\textCode{for (auto x : v)}}
            ...
            \subsection{References: Referencias}
                ...
                \begin{itemize}
                    \item Hacer que las funciones afecten los argumentos que les pasas y no a copias
                        ...
                        entonces podemos hacer que reciba el parametro por referencia:
                        \begin{lstlisting}[language=C++, gobble=28]
                            void add_3_to_this_number(int& number) {
                                number += 3;
                            }
                    ...
                    \item Evitar generar copias a lo estupido:
                        ...
                        \Quote{
                            \emph{You live in a house on a street in a town somewhere. 
                            I want to visit you to give you something.}

                            \emph{I have two choices - you can tell me your address, 
                        ...
                        \Quote{
                            \emph{Tu vives es una casa, en una calle cualquiera en algún pueblo.
                            Supón que te quiero visitar para darte algo.}

                            \emph{Tienes dos opciones - me puedes decir tu dirección y yo ire contigo o
