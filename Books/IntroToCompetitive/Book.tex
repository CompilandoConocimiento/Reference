        ...
        \section{Grandes ventajas de \Cpp}
            ...
            \begin{itemize}
                ...
                \item \textbf{Es prácticamente un \Quote{super set} de C}
                    ...
                    Es decir, que cualquier código válido de C es válido en \Cpp, esto es de gran ayuda pues
                    C es uno de los lenguajes más conocidos por lo que puede que la sintaxis de \Cpp sea
                    más fácil que entender la sintaxis de Haskell o de Kotlin o Prolog, por ejemplo. 
                ...
                \item {Tienes \textit{value types} por defecto}.
                    ...
                    \begin{verbatim} const person = { name: "Oscar", "age": 21 } \end{verbatim}

                    Resulta que \texttt{person} almacena una referencia a ese objecto y no a ese objecto en si, cosa que no pasa en \Cpp:

                    \begin{verbatim} const map<string, string> person { {"name", "Oscar"}, {"age", "21"} }; \end{verbatim}
    ...
    \chapter{Bases del Lenguaje}
        ...
        \section{Variables simples}
            ...
            \subsection{Declaraciones e Inicialización}
                ...
                aqui entre nos es decirle al compilador que le de a un fragmento de RAM un nombre y que usaremos
                ese nombre (o identificador) para referirnos.
        ...
        \section{Tipos de datos numéricos}
            ...
            \subsection{Integers: Enteros}
                ...
                nombre mas pequeños para los tipos de datos que ya conoces:
