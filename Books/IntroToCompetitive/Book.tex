...
% =======================================================
    ...
    \lstdefinestyle{CompilandoStyleSolarized} {                     %This is Code Style
        ...
        basicstyle          = \footnotesize\color{SolarizedFont},   %Style of text
        commentstyle        = \color{Green300MD},                   %Comment style
        stringstyle         = \color{Teal700MD},                    %String style
        keywordstyle        = \color{Blue700MD},                    %keywords style
        numberstyle         = \tiny\color{TealMD},                  %Size of a number
...
\part{Introducción a la Programación Competitiva}
    ...
    \chapter{¿Qué es la Programación Competitiva?}
        ...
        \section{Propiedades de un problema}
            ...
            \begin{itemize}
                \item Son calificados por una máquina
                ...
                \item El corazón del problema está relacionado siempre con matemáticas, lógica o
...
\part{Un tour de \Cpp y lo que deberías saber de el}
    ...
    \chapter{¿Porqué \Cpp?}
        ...
        \begin{figure}[h]
            \includegraphics[width=0.80\textwidth]{CppIntro}
        \end{figure}
    ...
    \chapter{Tipos de datos númericos}
        ...
        \section{Integers: Enteros}
            ...
            y estos son, de menor a mayor: \texttt{char, short, int, long, long long}.

            Ahora podemos aplicarles a estos tipos un modificador, \texttt{unsigned}, que nos permite que no
            puedan representar los negativos, a cambio nos da el doble de espacio, por lo
            que podemos representar un entero hasta el doble de grande.
            ...
            \subsection{unsigned}
                ...
                es eliminar el signo de los tipos númericos, es decir el entero mas bajo que vas
            ...
            \subsection{size\_t}
                ...
                Este es especial y muchas veces lo usaré como estandar de tipo numérico
