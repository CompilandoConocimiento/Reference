...
% =======================================================
    ...
    \newcommand{\pVector}[1]                                        %Use: \pVector {Matrix Notation} use paréntesis una lista de parameto ros que 
    ...
    \chapter{¿Porqué usar \Cpp?}
        ...
        \section{Grandes ventajas de \Cpp}
            ...
            \begin{itemize}
                ...
                \item {Tienes \textit{value types} por defecto (pero también referencias)}.
                    ...
                    cuando decimos \texttt{auto x = 10} nuestra variable \texttt{x} de verdad es el fragmento
                    ...
                    \begin{verbatim} const person = { month: 3, day: 21 } \end{verbatim}

                    Resulta que \texttt{person} almacena una referencia a ese objecto y no a ese objecto en si, cosa que no pasa en \Cpp:

                    \begin{verbatim} const map<string, int> person { {"month", 3}, {"day", 21} }; \end{verbatim}
    ...
    \chapter{Bases del Lenguaje}
        ...
        \section{Variables}
            ...
            \subsection{Declaraciones e Inicialización}
                ...
                aqui entre nos es decirle al compilador que le de a un fragmento de memoria 
                ...
                es decir, que al decir \texttt{int numberOfDays} nunca le estoy dando un valor a
                ...
                Por eso es tan poco común ver en la programación competitiva declaraciones SIN inicializaciones,
                pues generan una gran cantida de bugs que son difíciles de encontrar pues muchas veces
                por simple suerte la variable si se inicializa a un valor que tenga sentido, pero
                al ser este proceso aleatorio no es una gran idea depender de el.

                Además es una buena costumbre, no declarar variables hasta que tenga un valor coherente para
                las mismas.
        ...
        \section{Tipos de datos numéricos}
            ...
            \subsection{Integers: Enteros}
                ...
                Si necesitas tener presición y saber por seguro el tamaño de una variable puedes usar 
                \texttt{\#include <cstdint>} que no incluye otros tipos de datos diferentes sino solo
                nos da alias (typedef / using) o en otras palabras otros nombres 
                para los tipos de datos que ya conoces:
        ...
        \section{Los otros tipos de datos fundamentales}
            ...
            \subsection{void}
                ...
                Este es bastante sencillo, (si no cuentas *void), y simplemente indica
                un tipo de dato vacio, es usado para mostrar que una función no regresa nada.
        ...
        \section{References and value types: Referencias o Valores}
            ...
            \subsection{Value types: Variables de valor}
                ...
                de una "referencia a una variable". 
