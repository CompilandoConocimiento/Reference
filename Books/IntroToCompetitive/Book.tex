...
\part{Un tour de \Cpp y lo que deberías saber de el}
    ...
    \chapter{¿Porqué usar \Cpp?}
        ...
        \section{Grandes ventajas de \Cpp}
            ...
            \Link{https://youtu.be/5yFkAG6lOSg}{si no me crees dale click}.
            ...
            \begin{itemize}
                ...
                \item \textbf{Tienes a la biblioteca estándar, la gran std::* a tu lado}
                ...
                \item \textbf{Es \Quote{statically typed and compiled}; el compilador es tu amigo}
                    ...
                    Además, tras bambalinas está transformando tu código en algo que la computadora puede de verdad
                ...
                \item \textbf{Es prácticamente un \Quote{super set} de C}
                    ...
                    Otra ventaja es que al estar basado en C conserva muchas de las ventajas de C como su portabilidad, 
        ...
        \section{\Cpp vs otros lenguajes}
            ...
            \subsection{vs Python}
                ...
                Python es un gran lenguaje pero tiene todas las de perder en programación competitiva pues
                a ser interpretado y de tipado dinamico, sus programas acaban siendo muy lentos incluso usando el 
    ...
    \chapter{Instalando y corriendo programas de C++}
        ...
        \section{Corriendo C++}
            ...
            Una vez todo lo necesario este instalado, para correr recomiendo el siguiente
            comando:
            \begin{lstlisting}[language=C++, gobble=16]
                g++ -Wall -Wextra -Wshadow -Wpedantic 
                    -fsanitize=undefined -fsanitize=address 
                    -O2 -std=c++11 code.cpp
            \end{lstlisting}

            Ahora vamos por partes:
            \begin{itemize}
                \item \textCode{Wall, Wextra, Wshadow, Wpedantic}: son banderas que le indican al compilador
                que queremos que sea lo mas precavido con nuestro codigo, que queremos que nos muestre todos
                los errores que podriamos tener.
                \item \textCode{fsanitize=undefined, fsanitize=address}: Son banderas que 
                que nos permiten habilitar un detector rápido que busca partes de tu codigo que sean \Quote{undefined behavior},
                hablare de ello mas adelante si te interesa, pero en resumen hace que el compilador busque bugs muy obvios por ti.
                \item \textCode{O2}: Nos permite activar el optimizador, O2 es justo el mismo nivel que se usa
                en muchísimos jueces en linea por lo que es util activarlo. 
                \item \textCode{std=c++11}: Nos permite cambiar la versión de \Cpp a usar, por defecto esta bien usar 11, 
                a menos que esten en Codeforces y te puedas dar el lujo de usar la 17.
            \end{itemize}
    ...
    \chapter{Bases del Lenguaje Moderno}
        ...
        \section{Variables}
            ...
            % ============================================
            \subsection{Declaraciones e Inicialización (y \textCode{auto})}
            ...
            % ============================================
            % ======       UNIFORM INIZIALITION     ======
            % ============================================
            \subsection{Uniform (brace) Inicialization: Inicialización uniforme}
        ...
        Esta es una muy buena idea, hace la declaración de variables muy consistente, sobretodo,
        porque tiene las ventajas de las dos ultimas ideas anteriores:
        \begin{itemize}
            \item Usar \textCode{auto} todo lo posible, haciendo tu código mas fácil de entender, mas fácil
                de iterar y también mas corto.
            \item Usar \textCode{brace initialization}.
        \end{itemize}

        Eso si, hay que ser consistente de que esta forma de declarar es una mala idea en cosas
        queson caras de copiar o que no se pueden mover
        (como por ejemplo), \textCode{atomic, array, unique\_ptr}. 
        ...
        \section{References and value types}
            ...
            \subsection{References: Referencias}
                ...
                \begin{itemize}
                    ...
                    \clearpage
                    \item \textbf{Evitar generar copias a lo estúpido}:
        ...
        \section{Templates}
            ...
            \subsection{Parametrizar cosas que no son \textCode{type}}
                ...
                No solo podemos parametrizar tipos en sí, sino también podemos colocar variables
                que representan un número (integrals), 
                por ejemplo:
                \begin{lstlisting}[language=C++, gobble=20]
                ...
                \begin{itemize}
                    \item \textbf{Puedes separar la sincronización que esta por defecto}:
                        ...
                        \begin{lstlisting}[language=C++, gobble=28]
                            ...
                            // Will print some of the following:
                            //    -  "HelloCiaoWorld"
                            //    -  "HelloWorldCiao"
                            //    -  "CiaoHelloWorld"
                        \end{lstlisting}

                        Pero recuerda que si siempre usas la entrada y salida de \Cpp no hay problema:
                        \begin{lstlisting}[language=C++, gobble=28]
                            ios::sync_with_stdio(false);   
                    ...
                    \item \textbf{Puedes separar la sincronización entre la entrada y la salida}:
                    ...
                    \item \textbf{Puedes leer enteros de manera aún mas rápida}:
                        \lstinputlisting[language=c++, gobble=24]
...
\label{part:EstructurasDeDatosAvanzadas}
    ...
    \chapter{Tipos de datos definidos por nosotros}
        ...
        % =========================================================
        \clearpage
        \section{Declaración e implementación separadas}
