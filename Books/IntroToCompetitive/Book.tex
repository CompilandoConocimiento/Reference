    ...
    \chapter{Bases del Lenguaje Moderno}
        ...
        \section{Variables}
            ...
            \subsection{Declaraciones e Inicialización}
                ...
                % ======            SE SUTIL            ======
                % ============================================
                \subsubsection{Uniform (brace) Inizialization: Inicialización uniforme}
    ...
    \chapter{Cosas Avanzadas de \Cpp}
        ...
        \section{References types: Tipos de referencias}
            ...
            \subsection{auto vs auto\& vs const auto\& vs auto\&\&} 
                ...
                Usar algo como:
                \begin{lstlisting}[language=C++, gobble=20]
                    auto someValue {bla bla bla};
                \end{lstlisting}

                Solo nos dice, compilador, pon el tipo de dato que creas correcto aquí, pero poner 
                \textCode{auto} no hace nada relacionado con \textCode{const} o sobre la creación de 
                las referencias.

                Asií que veamos que hace cada una de las \Quote{modificaciones} que podemos hacerle al \textCode{auto}:
        ...
        \section{Semantics}   
            ...
            Siendo mas formales una semantica en este contexto es hablar como
