        ...
        \section{Variables}
            ...
            \subsection{Declaraciones e Inicialización}
                ...
                \subsubsection{Uniform (brace) Inicialization: Inicialización uniforme}
                    ...
                    \begin{itemize}
                        \item Supón que quieres inicializar por defecto un vector, entonces puedes hacer como:
    ...
    \chapter{Containers: Contenedores de la STD}
        ...
        \section{std::vector}
            ...
            \subsection{Inicialización}
                ...
                \begin{lstlisting}[language=C++, gobble=20]
                    vector<int> days (7, 0);    // vector with 7 ints, all start with 0
                \end{lstlisting}
            ...
            \subsection{Tips}
                ...
                \begin{itemize}
                    \item 
                        ...
                        Nota que \textCode{array}, se comporta de una manera un poco peculiar:
                        \begin{lstlisting}[language=C++, gobble=28]
                        ...
                        cuando y solo cuando estar inicializando cosas anidadamente.
                \end{itemize}
    ...
    \chapter{Cosas Avanzadas de \Cpp}
        ...
        \section{Sobre inicializar}  
            ...
            \subsubsection{(AAA) Almost always auto}
                ...
                (como por ejemplo), \textCode{vector, map, array, unique\_ptr}. Por lo que usalo con cuidado
