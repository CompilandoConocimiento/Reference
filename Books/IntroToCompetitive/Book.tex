...
\begin{titlepage}
    ...
    {\fontsize{35}{46}\selectfont                                   %Set size
        ...
        Programación Competitiva usando C++}}\\[0.5cm]  %Name of the book
...
\part{Un tour de \Cpp y lo que deberías saber de el}
    ...
    \chapter{Bases del Lenguaje Moderno}
        ...
        \textbf{
            ...
            siguiente capítulo dando click \underline{\hyperref[part:IdeasDeCienciasDeLaComputacion]{aquí}}
        }
    ...
    \chapter{Cosas Avanzadas de \Cpp}
        ...
        % =========================================================
        \clearpage
        \section{\&, \&\& y move semantics}

            % ============================================
            % =====    lvalues vs rvalues          =======
            % ============================================
            \subsection{lvalues vs rvalues}

                En \Cpp todas las cosas pueden clasificarse de dos manera como:
                \begin{itemize}
                    \item \textCode{lvalues}: 
                    
                        Son cosas que hacen referencia, en el sentido mas general de la palabra,
                        a una localización en memoria.

                        Otra forma de verlo es que algo que es un \textCode{lvalue} si y solo si 
                        ...
                        como cualquier cosa que podriamos poner a a izquierda de una asignación.
                    ...
                    \item \textCode{rvalues}:
                        ...
                        Son todas las cosas que no tienen una dirección en memoria, generalmente visto 
                        como temporales o constantes.
                ...
                Con esto encima podemos ver como es que podemos pasar parámetro por una referencia normal
                lo que estamos haciendo es una promesa, prometemos que quien haya llamado a  a una función
                y las diferencias entre estos:

                La primera forma sería pasar con valor.
            ...
            \subsection{lvalue references} 
                ...
                Las que habiamos son formalmente conocidas como lvalue references y 
                podemos ver un ejemplo de ellas aquí:
                \begin{lstlisting}[language=C++, gobble=20]
                    void func(Widget& pb);
                    Widget x;
                ...
                Esto no es válido porque cuando aceptamos un parámetro por una referencia normal
                lo que estamos haciendo es una promesa, prometemos que quien haya llamado a 
                \textCode{func}
                podrá ver los cambios que realiza la función.

                Pero al llamarla con un temporal es imposible ver los cambios que realiza, 
            ...
            \subsection{const lvalue references}  
                ...
                Esto no es válido porque cuando aceptamos un parámetro por una referencia constante
            ...
            \subsection{rvalue references}   
                ...
                Este tipo de referencias estan diciendonos que podemos modificar la información
                que entre a la función, pero que la persona que llamó a la función no podrá.
            ...
            % ==========          &&            ==========
            % ============================================
            \subsection{auto vs auto\& vs auto\&\&} 

                A pesar de que las referencias son solo otro tipo de dato usar \textCode{auto}
                puede traer sorpresas si no recuedas bien como funciona:
                \begin{lstlisting}[language=C++, gobble=20]
                    int numberOfDays {10};
                    auto& ref1 {numberOfDays};   // ref is an int&
                    auto&& ref2 {5};             // ref is an int&&
                    auto&& ref3 {numberOfDays};  // ref is an int&
                \end{lstlisting}
            ...
            % ============================================
            \clearpage
            \subsection{Move Semantics: Semanticas de Movimiento}     
