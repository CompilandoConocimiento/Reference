...
\chapter{Simple Graphs}
    ...
    \section{UnionFind - Disjoined set}
        \subsection{Simple UnionFind}
            \lstinputlisting[language=c++, linerange={1-35}, gobble=16]
            {../../Code/Graphs/UnionFind.cpp}

            \vfill\null
            \columnbreak
        
        \subsection{Real UnionFind}
            \lstinputlisting[language=c++, linerange={37-89}, gobble=16]
            {../../Code/Graphs/UnionFind.cpp}
